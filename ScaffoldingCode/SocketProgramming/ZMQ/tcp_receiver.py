...
# i.e., we receive the request but due to the REQ-REP semantics,
# are forced to send a null response.
#
# Plus, we added other decorations like comments, print statements,
# argument parsing, etc.
#
# We should be able to do this using the RADIO-DISH but
# it is in draft stage and is not working properly
#
